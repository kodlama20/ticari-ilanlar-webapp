  ...
  try {
    if (AGENT.step === 0) {
      ...
      if (r.status === 'ok') {
        ...
        say(`Birden çok eşleşme var: ${opts}. Lütfen tam ad yazın.`, 'ai');
      } else {
    ...
    if (AGENT.step === 1) {
      ...
      if (r.status === 'ok') {
        ...
        say(`Anladım, ${AGENT.date_from} – ${AGENT.date_to}. Peki ilan türü? (örn: "Kuruluş", "Genel Kurul", boş geçebilirsiniz)`, 'ai');
        AGENT.step = 2;
      } else {
